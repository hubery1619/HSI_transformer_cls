...
treatment_spell_path = r'/home/tirgan/a/liu3044/Project/Group_Transformer_hyper/leaderboard/logs/hu/proposed/hu_proposed_0_x0.02_hessian_matrics.csv'
links = []
...
treatment_spell_path = r'/home/tirgan/a/liu3044/Project/Group_Transformer_hyper/leaderboard/logs/hu/proposed/hu_proposed_0_x0.04_hessian_matrics.csv'
links = []
...
treatment_spell_path = r'/home/tirgan/a/liu3044/Project/Group_Transformer_hyper/leaderboard/logs/hu/proposed/hu_proposed_0_x0.06_hessian_matrics.csv'
links = []
...
treatment_spell_path = r'/home/tirgan/a/liu3044/Project/Group_Transformer_hyper/leaderboard/logs/hu/proposed/hu_proposed_0_x0.08_hessian_matrics.csv'
links = []
...
ax.plot(values1[:], probabilities1, label='0.02')
ax.plot(values2[:], probabilities2, label='0.04')
ax.plot(values3[:], probabilities3, label='0.06')
ax.plot(values4[:], probabilities4, label='0.08')
ax.plot(values5[:], probabilities5, label='1.0')


ax.set_xlabel("Values")
ax.set_ylabel("Probability")
ax.legend(labels=['0.02', '0.04', '0.06', '0.08', '1.0'])

save_path = 'output_result/hessian/' + str('hessian') + '_' + 'density_hyper_trans_0.1_80lowratio.png'
